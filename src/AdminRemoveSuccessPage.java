...
public class AdminRemoveSuccessPage extends JPanel {
	 ...
	 * Create the panel.
	 */
	public AdminRemoveSuccessPage(HomePage ob) {
		pswitch=ob;
		setLayout(null);
		setSize(594,391);
		
		JLabel lblBookSuccessfullyAdded = new JLabel("Book Successfully Removed");
